<?php
namespace JLTELIMF\Inc\Classes\Notifications\Base;
...
trait User_Data {
	...
	public function is_local_server() {
		...
		return apply_filters( 'jltelimf_is_local', $is_local );
	}
	...
	public function get_collect_data( $user_id, $arr = [] ){
		...
		$data = array(
			...
			'is_active_product'		  => 1,
			'installed_product_slug'  => JLTELIMF_SLUG,
		);

		$payload_data =  array_merge( $arr, $data );
		$endpoint_url = \JLTELIMF\Libs\Helper::crm_endpoint();
