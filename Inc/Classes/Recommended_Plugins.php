	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. master-image-feed-elementor-settings /  edit.php?post_type=page .
				__( 'Recommended', 'master-image-feed-elementor' ),
				__( 'Recommended', 'master-image-feed-elementor' ),
				'manage_options',
				'master-image-feed-elementor-recommended-plugins',
