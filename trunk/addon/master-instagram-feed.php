<?php
	namespace MasterInstagramElementor\Addon;
	 ...
	 */
     ...
     class Master_Instagram_Feed extends Widget_Base {
		...
		public function get_title(){
            return esc_html__( 'MA Instagram Feed', MIEL_TD );
		}
		...
		protected function _register_controls() {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Instagram Account Settings', MIEL_TD ),
				]
			);
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Access Token', MIEL_TD),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'default' => esc_html__('36409282899.8f4c5bf.2b5a056d124f4b83aa8bd90824d229d9', MIEL_TD),
                    'description' => '<a href="https://www.jetseotools.com/instagram-access-token/" class="jtlma-btn" target="_blank">Get Access Token</a>', MIEL_TD,
                ]
            );
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Feed Settings', MIEL_TD),
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'                 => esc_html__('Show Items', MIEL_TD),
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Sort By', MIEL_TD),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'recent-posts',
                    'options' => [
                        'recent-posts' => esc_html__('Recent Posts', MIEL_TD),
                        'old-posts' => esc_html__('Old Posts', MIEL_TD),
                        'most-liked' => esc_html__('Most Likes', MIEL_TD),
                        'less-liked' => esc_html__('Less Likes', MIEL_TD),
                        'most-commented' => esc_html__('Most Commented', MIEL_TD),
                        'less-commented' => esc_html__('Less Commented', MIEL_TD),
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Image Size', MIEL_TD),
                    'type' => Controls_Manager::SELECT,
                    'label_block' => false,
                    'default' => 'low_resolution',
                    'options' => [
                        'thumbnail' => esc_html__('Thumbnail (150x150)', MIEL_TD),
                        'low_resolution' => esc_html__('Low Resolution (320x320)', MIEL_TD),
                        'standard_resolution' => esc_html__('Standard Resolution (640x640)', MIEL_TD),
                    ],
                    'style_transfer' => true,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Force Square Image?', MIEL_TD),
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__('Image Dimension (px)', MIEL_TD),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 300,
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'                 => esc_html__( 'Display Settings', MIEL_TD ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Layout', MIEL_TD ),
                    'type'                  => Controls_Manager::SELECT,
                    'default'               => 'grid',
                    'options'               => [
                       'grid'           => esc_html__( 'Grid', MIEL_TD ),
                       'card'           => esc_html__( 'Card Style', MIEL_TD )
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'                 => esc_html__( 'Columns', MIEL_TD ),
                    'type'                  => Controls_Manager::SELECT,
                    'label_block'           => false,
                    'default'               => '4',
                    'tablet_default'        => '3',
                    'mobile_default'        => '2',
                    'options'               => [
                        '1'              => esc_html__( '1 Column', MIEL_TD ),
                        '2'              => esc_html__( '2 Columns', MIEL_TD ),
                        '3'              => esc_html__( '3 Columns', MIEL_TD ),
                        '4'              => esc_html__( '4 Columns', MIEL_TD ),
                        '5'              => esc_html__( '5 Columns', MIEL_TD ),
                        '6'              => esc_html__( '6 Columns', MIEL_TD ),
                        '7'              => esc_html__( '7 Columns', MIEL_TD ),
                        '8'              => esc_html__( '8 Columns', MIEL_TD )
                    ],
                    'selectors'             => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Hover Style', MIEL_TD),
                    'type' => Controls_Manager::SELECT,
                    'label_block' => false,
                    'default' => 'hover-info',
                    'options' => [
                        'hover-info'        => esc_html__('Default Hover', MIEL_TD),
                        'btm-push-hover'    => esc_html__('Bottom Push Hover', MIEL_TD)
                    ],
                    'style_transfer' => true,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Pagination', MIEL_TD),
            ...
            $this->add_control(
                ...
                [
                    'label' => __('Other Settings', MIEL_TD),
                    'type' => Controls_Manager::HEADING,
                    'separator'             => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Like?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'style_transfer' => true,
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Display Date', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Comments?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'style_transfer' => true,
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Caption?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'User Info', MIEL_TD ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Profile Picture?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Username?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Instagram Icon?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Show Post Date?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Image Link?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'No',
                    'style_transfer' => true,
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Open in new tab?', MIEL_TD),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => '_blank',
                    'default' => '_blank',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Show Link to Instagram Profile?', MIEL_TD ),
                    'type'                  => Controls_Manager::SWITCHER,
                    'default'               => 'no',
                    'label_on'              => esc_html__( 'Yes', MIEL_TD ),
                    'label_off'             => esc_html__( 'No', MIEL_TD ),
                    'return_value'          => 'yes',
                    'separator'             => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Link Title', MIEL_TD ),
                    'type'                  => Controls_Manager::TEXT,
                    'default'               => esc_html__( 'Follow Us @ Instagram', MIEL_TD ),
                    'condition'             => [
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Instagram Profile URL', MIEL_TD ),
            ...
            $this->add_control(
                ...
                [
                    'label'					=> esc_html__( 'Title Icon', MIEL_TD ),
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Icon Position', MIEL_TD ),
                    'type'                  => Controls_Manager::SELECT,
                    'options'               => [
                       'before_title'   => esc_html__( 'Before Title', MIEL_TD ),
                       'after_title'    => esc_html__( 'After Title', MIEL_TD ),
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Layout Style', MIEL_TD),
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'                 => esc_html__( 'Columns Gap', MIEL_TD ),
                    'type'                  => Controls_Manager::SLIDER,
                    'default'               => [
                        'size' => '',
                        'unit' => 'px',
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'                 => esc_html__( 'Rows Gap', MIEL_TD ),
                    'type'                  => Controls_Manager::SLIDER,
                    'default'               => [
                        'size' => '',
                        'unit' => 'px',
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Container Background', MIEL_TD),
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Padding', MIEL_TD ),
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Margin', MIEL_TD ),
                    'type'                  => Controls_Manager::DIMENSIONS,
                    'size_units'            => ['px', 'em', '%'],
                    'selectors'         => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Instagram Item Style', MIEL_TD),
                    'tab' => Controls_Manager::TAB_STYLE,
                    'condition'             => [
                        'jltma_instafeed_layout'       => ['grid', 'card']
                    ],
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Item Background', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Border Radius', MIEL_TD),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => ['px', '%'],
                    'selectors' => [
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => esc_html__('Border', MIEL_TD),
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Card Header BG', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Card Footer BG', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Username Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Likes Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Likes Hover Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Comments Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Comments Hover Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Date Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Instagram Icon Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Date Hover Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Caption Color', MIEL_TD),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            */
            $this->start_controls_section(
                ...
                [
                    'label'                 => esc_html__( 'Images', MIEL_TD ),
                    'tab'                   => Controls_Manager::TAB_STYLE,
                ]
            );
            ...
            $this->start_controls_tab(
                ...
                [
                    'label'                 => esc_html__( 'Normal', MIEL_TD ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Grayscale Image', MIEL_TD ),
                    'type'                  => Controls_Manager::SWITCHER,
                    'default'               => 'no',
                    'label_on'              => esc_html__( 'Yes', MIEL_TD ),
                    'label_off'             => esc_html__( 'No', MIEL_TD ),
            ...
            $this->start_controls_tab(
                ...
                [
                    'label'                 => esc_html__( 'Hover', MIEL_TD ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'                 => esc_html__( 'Border Color', MIEL_TD ),
                    'type'                  => Controls_Manager::COLOR,
                    'default'               => '',
                    'selectors'             => [
